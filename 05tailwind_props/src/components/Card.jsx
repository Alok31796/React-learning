  ...
  return (
   <div className="w-60 h-60 rounded-xl">
        ...
        <div className="glass py-4 px-5 relative -top-[3.4rem]  rounded-b-xl z-10">
          <h1 className="font-bold  font-mono  text-xl text-red-500">{username}</h1>
          <h1 className="font-bold  font-mono  text-xl text-red-500">{btnText}</h1>
        </div>
      </div>
  )
}
